...
agent_io = agent_executor.invoke({"input": "Give me the result of 2 * 3 + 2 and then tell me the current weather in Denmark, Copenhagen."})
print("AI: " + agent_io.get("input"))
print("User:" + agent_io.get("output"))